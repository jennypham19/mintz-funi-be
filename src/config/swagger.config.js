...
const swaggerDefinitionObject = { // Đổi tên để tránh nhầm lẫn với key 'definition' của options
  ...
  info: {
    ...
    version: version,
    description:
      'API documentation for the Hotel Management System. This API allows managing rooms, tasks, users, and reports.',
    license: {
      name: 'MIT',
  ...
  components: {
    // Các components (schemas, responses, securitySchemes) sẽ được swagger-jsdoc
